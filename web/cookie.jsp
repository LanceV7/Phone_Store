...
<html>
<head>
    <title>PhoneStore-Cookie</title>
</head>
<%@include file="nav.jsp"%>
<body>
Come chiarito dal Garante Privacy nelle FAQ del dicembre 2012, reperibili su www.garanteprivacy.it, i cookie sono “piccoli file di testo” – formati da lettere e numeri -  “che i siti visitati dall'utente inviano al suo terminale (solitamente al browser), dove vengono memorizzati per essere poi ritrasmessi agli stessi siti alla successiva visita del medesimo utente”. I cookie hanno la funzione di snellire l'analisi del traffico sul web o di segnalare quando un sito specifico o una parte di esso vengono visitati, di distinguere tra loro i visitatori per poter fornire contenuti personalizzati, ed aiutano gli amministratori a migliorare il sito e l’esperienza di navigazione degli utenti stessi.
